...
struct
  ...
  val chooseChecker = Checker.fromRefsol (uncurry2 StuSeqUtil.choose,
                                          ...
                                          StringElt.equal)  
  val chooseShower = Checker.fromRefsol (uncurry2 OurSeqUtil.choose,
                                          uncurry2 StuSeqUtil.choose,
                                          StringElt.equal)
  val kGramStatsChecker = Checker.fromRefsol (stuLookupExts,
                                              ourLookupExts,
                                              StringIntPairSeqElt.equal)
  val kGramStatsShower = Checker.fromRefsol (ourLookupExts,
                                              stuLookupExts,
                                              StringIntPairSeqElt.equal)
  ...
  fun showChoose () =
  	Tester.testGroup chooseShower chooseLogger testsChoose
  fun testKGramStats () =
    Tester.testGroup kGramStatsChecker kGramStatsLogger testsKGramStats
  fun showKGramStats () =
    Tester.testGroup kGramStatsShower kGramStatsLogger testsKGramStats
